...
import lightAvatar from '../../assets/avatar.png';
import darkAvatar from '../../assets/avatarDark.png';

// componente que renderiza a imagem do meu avatar
const Avatar: React.FC = () => {
  // estados para monitora o thema e o carregamento da img
  ...
  useEffect(() => {
    ...
    // Adiciona o ouvinte para o evento 'themeChange' que e passado la na mudança de tema fazendo com que o avatar aquo tambem mude
...
// seta o avatar que sera mostrado comforme o tema
  const avatarSrc = themeIcon === 'light' ? lightAvatar : darkAvatar; 
